...
public interface InfoMapper {
    ...
    @Select("select * from meeting left join meeting_image on meeting.idx = meeting_image.meeting_idx group by meeting.idx order by binary(start_datetime) desc ") //최신순
